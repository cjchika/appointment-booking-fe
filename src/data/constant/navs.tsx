...
import { Home, UserBooking, AdminDashboard, Register, Login } from '@/pages';
...
const authNavList: TypeNavs[] = authNavs.map((nav) => ({
  key: nav.key,
  label: nav.label,
}));
...
export { routeList, menuList, navList, authNavList };
